import re
from budynki.variables import aa_nr_kw
...
def kw(line):
    if AF.search(line):
        ...
        if (len(re.findall('(,|;)', res12prim2)) == 0):
            aa_nr_kw.append(re.sub(r'\s', '', re.sub(r'l', '/', res12prim2)))
            pozostale_ksiegi = ""
            ...
            aa_nr_kw.append(d_ksiega_pierwsza1)
            ...
            aa_nr_kw.append(re.sub(r'\s', '', d_ksiega_pierwsza))
        ...
        aa_nr_kw.append('')
        pozostale_ksiegi = ""
    return aa_nr_kw, pozostale_ksiegi
